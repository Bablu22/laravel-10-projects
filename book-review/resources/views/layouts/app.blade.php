...
<head>
  ...
  <style type="text/tailwindcss">
    ...
    .input {
      @apply shadow-sm appearance-none border w-full py-2 px-3 text-slate-700 leading-tight focus:outline-none rounded-md border-slate-300 h-10;
    }
...
<body class="container mx-auto mt-10 mb-10 max-w-3xl">
    <header class="bg-gray-800 py-4 rounded mb-2">
        <div class="container mx-auto flex justify-between items-center px-4">
            <h1 class="text-white font-bold">BOOK REVIEW</h1>
            <nav class="space-x-4">
                <a href="{{ route('books.index') }}" class="text-white font-semibold">Home</a>
            </nav>
        </div>
    </header>
    @yield('content')
